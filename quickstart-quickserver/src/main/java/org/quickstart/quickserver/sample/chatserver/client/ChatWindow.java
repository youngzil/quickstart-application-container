...
package org.quickstart.quickserver.sample.chatserver.client;
...
public class ChatWindow extends JFrame {
    ...
    private void loginMenuItemActionPerformed(final ActionEvent evt) {
		Thread t = new Thread() {
			public void run() {
				while(true) {
    ...
    private void sendTextActionPerformed(ActionEvent evt) {
       sendButtonActionPerformed(evt);
    }                                        
    
    private void sendPrivateButtonActionPerformed(ActionEvent evt) {
    ...
    private JTextPane chatRoomTextPane1;
	...
	private JMenuItem changeRoomMenuItem;
	private JMenuItem updateUserListMenuItem;
	...
	private void buildMenu() {
        ...
        changeRoomMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
				java.awt.EventQueue.invokeLater(new Runnable() {
		            public void run() {
		                changeRoom();
